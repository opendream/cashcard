        ...
        <div class="control-group ${hasErrors(bean: memberInstance, field: 'gender', 'error')}">
          ...
          <div class="controls">
            <div class="btn-group" data-toggle="buttons-radio">
              ...
              <label class="btn ${memberInstance?.gender == Gender?.MALE? 'active': null}">${message(code: 'member.label.male', default: 'Male')} <input style="display:none;" type="radio" name="gender" ${memberInstance?.gender == Gender?.MALE? 'checked': null} value="MALE"/> </label>
              <label class="btn ${memberInstance?.gender == Gender?.FEMALE? 'checked': null}">${message(code: 'member.label.female', default: 'Female')}<input style="display:none;" type="radio" name="gender" ${memberInstance?.gender == Gender?.FEMALE? 'checked': null} value="FEMALE"/> </label>
            </div>
          </div>
        </div>
