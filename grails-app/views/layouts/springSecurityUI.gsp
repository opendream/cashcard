	...
	<div>
		...
		<div>
			...
			<ul class="jd_menu jd_menu_slate">
				...
				<li><a class="accessible"><g:message code="spring.security.ui.menu.companies" default="Companies"/></a>
					<ul>
						<li><g:link controller="company" action='search'><g:message code="spring.security.ui.search"/></g:link></li>
						<li><g:link controller="company" action='create'><g:message code="spring.security.ui.create"/></g:link></li>
					</ul>
				</li>
