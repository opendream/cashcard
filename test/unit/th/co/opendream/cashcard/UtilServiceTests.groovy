...
class UtilServiceTests {
    ...
    void testMoneyRoundDown() {
    	assert service.moneyRoundDown(0.00) == 0.00
    	assert service.moneyRoundDown(100.20) == 100.00
    	assert service.moneyRoundDown(100.34) == 100.25
    	assert service.moneyRoundDown(100.73) == 100.50
    	assert service.moneyRoundDown(100.84) == 100.75
    }
}
